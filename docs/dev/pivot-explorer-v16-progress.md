...
- **Status:** 32 done — the §9 plan and the 7-task P0 sweep (12–18) · §3.7 answered 2026-09-23 (PRD §5 *Rulings*, P0 + R1–R6); both upstream requests landed in `1296966`
- **Tests:** `node tests/js/pivot-explorer-graph.test.js` — 141 cases, 473 assertions, no dependencies
...
| 12 | Remove what the correlation pivots brought (`removeBySource`) | ✅ | 5, 5d | 2026-09-23 — canvas menu; not in Undo, a library gap filed upstream. See §2 |
