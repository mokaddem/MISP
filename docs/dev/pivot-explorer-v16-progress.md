...
- **Status:** 31 done — the §9 plan, and 6 of the 7-task P0 sweep (12–18) · §3.7 answered 2026-09-23 (PRD §5 *Rulings*, P0 + R1–R6); both upstream requests landed in `1296966`
- **Tests:** `node tests/js/pivot-explorer-graph.test.js` — 139 cases, 464 assertions, no dependencies
