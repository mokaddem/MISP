...
| 33 | The two tag scopes fold into one list — the split, the glyph and the second facet withdrawn; clusters grouped by galaxy | `live/33-tag-scope-fold.md` | **built 2026-09-14** — §1 why the split was the wrong shape, §2 the `×N` it costs and why it is not bought back, §3 the four surfaces, §4 the three height budgets, §6 `Q` down from 9–18 to 8–15, §7 what was checked live |
