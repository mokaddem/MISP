...
since grown to twenty-four phases and this subsection is the current state.
...
| — | The analyst profile — what configures the verdict engine, and the enrichment defaults | [`analyst-profile/01-profile.md`](analyst-profile/01-profile.md) | **designed, nothing built.** Unblocks the verdict engine. Ten phases, each in its own file; §1.4 there is the phase table and §2 the decisions. The discovery pass and the grilling agenda are `analyst-profile/00-discovery.md` |
