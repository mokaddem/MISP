...
| Occurrences | `viewOccurrenceTable` | `value_occurrence_table` | **7–9** | nothing — flat in occurrence count | 1, two aggregates at 2 | **22**; the tenth is the standalone-proposal fetch added by [**22b**](22b-standalone-proposals.md), which is §14.12's amended row taken as that section instructs |
