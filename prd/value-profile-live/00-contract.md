...
| Overview | `viewOccurrences` | `value_occurrences` | 9 | nothing — capped at 25 rows, and the totals are aggregates | 1, two aggregates at 2 | **29** |
| Overview | `viewContext` | `value_context` | 3 | nothing — the tag read is capped at 60, `443` carries 3,860 | 2, one aggregate at 2 | **29**, and §14.4 there is the 2.9 MB fragment that made it a cap |
